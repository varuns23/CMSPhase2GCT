...
void test() {
   ...
   // set-3: For testing eta and phi stitching
    towersInPosEta[6][16].cluster_et = 23; //fdc06c17 -
    towersInPosEta[6][16].tower_et     = 27;
    towersInPosEta[6][16].peak_phi     = 4;
    towersInPosEta[6][16].peak_eta     = 3;

    towersInPosEta[10][16].cluster_et = 40; //fd80b428 -
    towersInPosEta[10][16].tower_et     = 45;
    towersInPosEta[10][16].peak_phi     = 0;
    towersInPosEta[10][16].peak_eta     = 3;

    towersInPosEta[11][16].cluster_et = 37; //fd409c25 -
    towersInPosEta[11][16].tower_et     = 39;
    towersInPosEta[11][16].peak_phi     = 4;
    towersInPosEta[11][16].peak_eta     = 2;

    towersInPosEta[12][16].cluster_et = 12; //fd00300c -
    towersInPosEta[12][16].tower_et     = 12;
    towersInPosEta[12][16].peak_phi     = 0;
    towersInPosEta[12][16].peak_eta     = 2;
    ...
    towersInNegEta[7][0].cluster_et = 66; //fd411c42 -
    towersInNegEta[7][0].tower_et     = 71;
    towersInNegEta[7][0].peak_phi     = 4;
    towersInNegEta[7][0].peak_eta     = 2;

    towersInNegEta[8][0].cluster_et = 14; //fd00400e -
    towersInNegEta[8][0].tower_et     = 16;
    towersInNegEta[8][0].peak_phi     = 0;
    towersInNegEta[8][0].peak_eta     = 2;
