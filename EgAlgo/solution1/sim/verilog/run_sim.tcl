...
if {[file isfile bitonicSort.autotvin.dat]} {
	file delete -force bitonicSort.autotvin.dat
}

if {[file isfile bitonicSort.autotvout.dat]} {
	file delete -force bitonicSort.autotvout.dat
}
