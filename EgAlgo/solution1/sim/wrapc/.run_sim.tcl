...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /data/tools/Xilinx/Vivado/2019.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/tools/Xilinx/Vivado/2019.1/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/tools/Xilinx/Vivado/2019.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/tools/Xilinx/Vivado/2019.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/tools/Xilinx/Vivado/2019.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "bitonicSort.autotvin.dat"
	set constFileTvOut       "bitonicSort.autotvout.dat"
	set constFileHdlTvIn     "bitonicSort.autohdltvin.dat"
	set constFileHdlTvOut    "bitonicSort.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
