...
AUTOPILOT_ROOT := /data/tools/Xilinx/Vivado/2019.1
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /data/tools/Xilinx/Vivado/2019.1/tps/lnx64/gcc-6.2.0/bin
endif
...
$(ObjDir)/bitonicSort_tb.cpp_pre.cpp.tb.o : bitonicSort_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling bitonicSort_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/bitonicSort.cpp_pre.cpp.tb.o : bitonicSort.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling bitonicSort.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
